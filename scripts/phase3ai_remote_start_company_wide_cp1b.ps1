...
$Archive = "D:\HermesWorker\runtime\phase3ai_wide_cp1b_source_20260604.zip"
$RepoRoot = "D:\HermesWorker\workspace\phase3ai_wide_cp1b_current"
...
$LaunchRoot = "D:\p3ai\wide_cp1b_20260604"
$JobId = "phase3ai_wide_cp1b_20260604_company"
...
# CP1 failed because the mature memory/policy layer filtered every generated
# candidate before validation. CP1b keeps memory enabled but relaxes it enough
# to prove the checkpoint path is producing retained ledger rows.
$argsList = @(
  ...
  "--parallel-workers", "1",
  "--previous-root-limit", "60",
  "--reward-root-limit", "30",
  "--max-family-share", "0.25",
  "--reward-exploration-share", "0.85",
