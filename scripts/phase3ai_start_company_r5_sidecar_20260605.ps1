...
$RemoteScript = "D:/HermesWorker/runtime/phase3ai_remote_start_company_r5_sidecar_20260605.ps1"
$LocalRemoteScript = Join-Path $RepoRoot "scripts\phase3ai_remote_start_company_r5_sidecar_20260605.ps1"
...
powershell -ExecutionPolicy Bypass -File $RemoteTool -Action start-detached -DetachedCommand "powershell -ExecutionPolicy Bypass -File D:\HermesWorker\runtime\phase3ai_remote_start_company_r5_sidecar_20260605.ps1"
