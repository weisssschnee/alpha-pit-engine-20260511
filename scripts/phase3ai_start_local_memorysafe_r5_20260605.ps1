...
$Script = "G:\Project_V7_Rotation\alpha_pit_data_feature_workspace_20260531\scripts\phase3ai_local_memorysafe_r5_worker_20260605.ps1"
$LogDir = "G:\Project_V7_Rotation\runtime\phase3ai_overnight_local_20260605_r5_memorysafe"
New-Item -ItemType Directory -Force -Path $LogDir | Out-Null
$LogPath = Join-Path $LogDir "local_memorysafe_launcher.log"
$StatusPath = Join-Path $LogDir "local_memorysafe_launcher_status.json"
...
$LaunchScript = Join-Path $LogDir "launch_local_memorysafe.ps1"
...
Write-Output "LOCAL_MEMORYSAFE_R5_STARTED"
