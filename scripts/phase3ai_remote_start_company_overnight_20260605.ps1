...
$RunRoot = "D:\p3ai\overnight_company_20260605"
...
$legs = @(
  [ordered]@{name="c3_rx_deep_broad"; mode="rx_typed_beam"; canary_shards=6; shards=96; max_active=4; candidates=64; windows=72; beam_width=768; max_beam=131072; family_share=0.08; exploration=0.82; previous_limit=180; reward_limit=90; halving_fraction=0.38; halving_min=48; canary_min_eval=80},
  [ordered]@{name="c4_forward_fresh"; mode="forward_first"; canary_shards=6; shards=96; max_active=4; candidates=96; windows=72; beam_width=64; max_beam=8192; family_share=0.12; exploration=0.78; previous_limit=180; reward_limit=90; halving_fraction=0.35; halving_min=64; canary_min_eval=80},
  [ordered]@{name="c5_rx_orthogonal"; mode="rx_typed_beam"; canary_shards=8; shards=128; max_active=4; candidates=48; windows=96; beam_width=1024; max_beam=196608; family_share=0.04; exploration=0.86; previous_limit=220; reward_limit=110; halving_fraction=0.42; halving_min=40; canary_min_eval=48},
  [ordered]@{name="c6_forward_lowcap"; mode="forward_first"; canary_shards=6; shards=96; max_active=4; candidates=96; windows=96; beam_width=64; max_beam=8192; family_share=0.10; exploration=0.82; previous_limit=220; reward_limit=110; halving_fraction=0.35; halving_min=64; canary_min_eval=80},
  [ordered]@{name="c7_rx_gap_family_deep"; mode="rx_typed_beam"; canary_shards=8; shards=160; max_active=4; candidates=48; windows=120; beam_width=1536; max_beam=262144; family_share=0.12; exploration=0.74; previous_limit=260; reward_limit=130; halving_fraction=0.40; halving_min=48; canary_min_eval=48},
  [ordered]@{name="c8_forward_extended"; mode="forward_first"; canary_shards=8; shards=160; max_active=4; candidates=128; windows=120; beam_width=64; max_beam=8192; family_share=0.12; exploration=0.80; previous_limit=260; reward_limit=130; halving_fraction=0.35; halving_min=80; canary_min_eval=80},
  [ordered]@{name="c9_rx_ultra_orthogonal"; mode="rx_typed_beam"; canary_shards=8; shards=160; max_active=4; candidates=40; windows=144; beam_width=1536; max_beam=262144; family_share=0.03; exploration=0.80; previous_limit=300; reward_limit=160; halving_fraction=0.45; halving_min=40; canary_min_eval=48}
)
