...
$Archive = "D:\HermesWorker\runtime\phase3ai_wide_cp2a_source_20260604.zip"
$RepoRoot = "D:\HermesWorker\workspace\phase3ai_wide_cp2a_current"
...
$LaunchRoot = "D:\p3ai\wide_cp2a_20260604"
$JobId = "phase3ai_wide_cp2a_20260604_company"
...
# CP2a expands the rx beam/window search after CP1c proved the path works.
# It keeps memory enabled but tightens family concentration to avoid repeating
# the CP1c open-gap x volatility family as the whole checkpoint.
$argsList = @(
