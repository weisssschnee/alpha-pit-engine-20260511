...
rows: `859129`
feature_count: `52`
mean_feature_nonnull_rate: `0.395416`
...
- `uplimit_stock_event_day`: `{'feature_count': 12, 'mean_nonnull_rate': 0.0004702437003057749, 'matched_rows': 413}`
- `ths_hot_stock_day`: `{'feature_count': 5, 'mean_nonnull_rate': 0.001842563805901093, 'matched_rows': 1583}`
- `candidate_transform_plan`: requested=`205`, materialized=`52`, lag1_event_aliases=`12`, deferred/skipped=`161`
