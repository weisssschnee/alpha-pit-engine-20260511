...
Phase3G is confirmed at the search-mechanics level.
...
Current production research baseline remains non-commercial. This result confirms a better pre-replay clustering proxy for search selection; it does not prove fund-level deployability.
