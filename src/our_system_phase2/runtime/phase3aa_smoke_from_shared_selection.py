"""Replay Phase3AA frozen selector output without regenerating candidates."""
...
def main() -> int:
    ...
    write_json_artifact(
        args.output_root / "phase3aa_smoke_from_shared_selection_manifest.json",
        {
            "created_at": utc_now_iso(),
            "selection_root": str(args.selection_root),
            "arm": summary,
            "schema_version": "phase3aa-smoke-from-shared-selection-v1",
        },
    )
